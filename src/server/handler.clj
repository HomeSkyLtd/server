...
(def ^:private ^{:doc "Map of functions to their names."}
	function-handlers {
		...
		"forceRuleLearning" rule/force-rule-learning
...
(def ^:private ^{:doc "List of permissions to access each function."}
	function-permissions {
		...
		"forceRuleLearning" (bit-or (permissions "admin") (permissions "user")),
		...
		"getUsers" (bit-or (permissions "admin") (permissions "user")),
